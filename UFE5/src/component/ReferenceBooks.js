...
//     .sort((a, b) => {
//       const aMatch =
//         a.Bookname.toLowerCase().includes(searchTerm.toLowerCase()) ||
...
//           }}
//         >
//           Reference books is not allowed to reserve
//         </Typography>
...
const ReferenceBooks = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        const response = await axios.get("http://localhost:9000/api/referencebooks");
    ...
    <Box sx={{ 
      ...
      <Container maxWidth="md" sx={{ 
        ...
        <Box sx={{ 
          ...
          >
            Reference books cannot be reserved or checked out
          </Alert>
        </Box>
          ...
          <Paper sx={{ 
            ...
            <Typography variant="body1" color="text.secondary">
              {searchTerm ? 
                ...
                "No reference books available in the collection"}
            </Typography>
          </Paper>
        )}
      </Container>
